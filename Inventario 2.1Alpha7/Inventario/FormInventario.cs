        ...
        private void seleccionarModInventario(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button.ToString() == "Left")
            {
                try
                {
                    ...
                    textBoxModInventarioFlete.Text = "" + Math.Round((Convert.ToDouble(new Numeros(listViewModInventario.SelectedItems[0].SubItems[7].Text).numeroSolo())* imporE) - Convert.ToDouble(textBoxModInventCostoE.Text), 2);
        ...
        private void buttonModificarRealizar_Click(object sender, EventArgs e)
        {
            ...
            foreach (string[] producto in productos)
            {
                if (producto[0].Equals(textBoxModInventNuParte.Text))
                {
                    ...
                    double costoImporte;
                    costoImporte = (Convert.ToDouble(producto[5] + textBoxModInventarioFlete.Text) / importE)* 100;
                ...
                else if (textBox1.Text.Equals("mandar inventario")) 
                {
                    if (File.Exists("c:\\InventarioOrdenado.xlsx"))
                    {
                        ...
                        {                           // 1,  2, 3,  4,   5,  6,  7,  8, 9
                            ...
                            fresia.editarProducto(datosCliente);
