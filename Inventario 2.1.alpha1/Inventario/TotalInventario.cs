...
namespace Inventario
{
    public partial class FormInventario
    {
        ...
        private void cargarModificarInventarioCompleto()
        {
        ...
        private void cargarModificarInventario()
        {
            cargarInventario();
        ...
        //para ver Inventario
        private void cargarInventarioCompletoHilo2()
        {
            cargarInventario();
            deTotalInventarioAVerInventario();
        }
        private void cargarVerInventarioCompleto()
        {
            listViewTOTALinventario.Items.Clear();
